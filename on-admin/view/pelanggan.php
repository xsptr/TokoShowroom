                  ...
                  ?>
                    ...
                    <td>
                      <div class="btn-group">
                        ...
                        <a class="btn btn-danger" href="?page=pelanggan&act=delete&id=<?php echo $r['id_customer']?>" onclick="return confirm('Apakah anda yakin akan menghapusnya ?');"><i class="icon_close_alt2"></i></a>
                      </div>
                    </td>
                  </tr>
                  <?php
...
//proses
    ...
    $d = mysqli_query($db,"SELECT * FROM customer WHERE id_customer='$_GET[id]'");
      $d = mysqli_fetch_array($d);
        ...
        case 'delete':
          mysqli_query($db, "DELETE FROM customer WHERE id_customer='$_GET[id]'");
          echo "<script>window.location='?page=pelanggan&act=view'</script>";
          break;
        }
        ?>
